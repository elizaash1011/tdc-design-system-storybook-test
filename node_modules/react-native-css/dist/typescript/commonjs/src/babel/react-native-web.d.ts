...
import tBabelTypes, { type CallExpression, type ImportDeclaration, type ObjectPattern, type Statement, type VariableDeclaration } from "@babel/types";
...
export declare function handleReactNativeWebInteropRequireDefault(path: NodePath<VariableDeclaration>, t: BabelTypes, id: string, init: CallExpression, source: string, filename: string): tBabelTypes.VariableDeclaration[] | undefined;
