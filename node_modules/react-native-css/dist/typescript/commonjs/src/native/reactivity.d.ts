...
/** Color Scheme **************************************************************/
export declare const colorScheme: Observable<ColorSchemeName | null | undefined, ColorSchemeName | null | undefined>;
/** Containers ****************************************************************/
export type ContainerContextValue = Record<string, {
    key: WeakKey;
