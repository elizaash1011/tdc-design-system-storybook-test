...
import type { AnimationKeyframes, AnimationRecord, CompilerOptions, ContainerQuery, MediaCondition, ReactNativeCssStyleSheet, StyleDeclaration, StyleDescriptor, StyleRule, StyleRuleMapping, StyleRuleSet, VariableRecord } from "./compiler.types.js";
