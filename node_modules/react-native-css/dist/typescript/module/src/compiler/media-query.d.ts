...
import type { MediaFeatureComparison, StyleDescriptor } from "./compiler.types.js";
import type { StylesheetBuilder } from "./stylesheet.js";
export declare function parseMediaQuery(query: CSSMediaQuery, builder: StylesheetBuilder): boolean;
