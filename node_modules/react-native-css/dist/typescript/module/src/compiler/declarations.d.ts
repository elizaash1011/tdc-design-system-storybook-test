...
import type { StyleDescriptor, StyleFunction } from "./compiler.types.js";
import type { StylesheetBuilder } from "./stylesheet.js";
...
export declare function parseBorderInlineStyle(declaration: DeclarationType<"border-inline-style" | "border-inline-start-style" | "border-inline-end-style" | "border-block-start-style" | "border-block-end-style">, builder: StylesheetBuilder): void;
...
export declare function parsePointerEvents({ value }: {
    value: string;
}, builder: StylesheetBuilder): "none" | "auto" | "box-none" | "box-only" | undefined;
