...
import type { ColorScheme, Props, ReactComponent, Styled, StyledConfiguration } from "../runtime.types.js";
import { useNativeCss } from "./react/useNativeCss.js";
 ...
 */
export declare function vars(variables: Record<string, StyleDescriptor>): ViewStyle;
