...
const animationShorthand = exports.animationShorthand = (0, _handler.shorthandHandler)([[name], [duration, name], [name, duration], [name, duration, timingFunction], [duration, timingFunction, name], [name, duration, iteration], [name, duration, timingFunction, iteration], [duration, delay, name], [duration, delay, iteration, name], [duration, delay, iteration, timingFunction, name], [name, duration, timingFunction, delay, iteration, fill]], [name, delay, direction, duration, fill, iteration, playState, timingFunction], "tuples");
