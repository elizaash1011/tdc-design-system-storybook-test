...
var _logicalBorderWidth = require("./logical-border-width.js");
Object.keys(_logicalBorderWidth).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  if (key in exports && exports[key] === _logicalBorderWidth[key]) return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function () {
      return _logicalBorderWidth[key];
    }
  });
});
