...
exports.sepia = exports.saturate = exports.opacity = exports.invert = exports.hueRotate = exports.grayscale = exports.filter = exports.dropShadow = exports.contrast = exports.brightness = exports.blur = void 0;
...
const opacity = (resolveValue, value) => {
  const args = resolveValue(value[2]);
  return {
    opacity: Array.isArray(args) ? args[0] : args
  };
};
...
const standardDeviation = ["standardDeviation", "number"];
const handler = (0, _handler.shorthandHandler)([[offsetX, offsetY, standardDeviation, color], [color, offsetX, offsetY], [color, offsetX, offsetY, standardDeviation], [offsetX, offsetY, color], [offsetX, offsetY, standardDeviation, color]], [], "object");
...
const filter = (resolveValue, descriptor) => {
  const value = resolveValue(descriptor[2]);
  if (Array.isArray(value)) {
    const filters = value.flat(Infinity);
    return filters.filter(entry => entry !== undefined && entry !== "initial");
  }
