...
var _scaleFactor = require("../scale-factor.js");
const scale = (resolveValue, descriptor) => {
  const args = descriptor[2];
  if (!(0, _utilities.isStyleDescriptorArray)(args)) {
    return {
      scale: (0, _scaleFactor.scaleFactor)(resolveValue(args))
    };
  }
  const x = (0, _scaleFactor.scaleFactor)(resolveValue(args[0]));
  const y = (0, _scaleFactor.scaleFactor)(resolveValue(args[1]));
