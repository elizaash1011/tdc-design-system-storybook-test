...
const colorScheme = exports.colorScheme = {
  ...
  set(value) {
    return _reactivity.colorScheme.set(value === "unspecified" ? null : value);
  }
};
...
function useNativeVariable(name) {
  ...
  const [effect] = (0, _react.useState)(() => {
    const effect = {
      observers: new Set(),
  ...
  (0, _react.useEffect)(() => {
    ...
    return () => (0, _reactivity.cleanupEffect)(effect);
  }, [effect]);
  (0, _reactivity.cleanupEffect)(effect);
