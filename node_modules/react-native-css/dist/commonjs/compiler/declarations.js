...
exports.addAnimationValue = addAnimationValue;
exports.addTransitionValue = addTransitionValue;
exports.allEqual = allEqual;
exports.equal = equal;
exports.kebabCase = kebabCase;
exports.parseAlignContent = parseAlignContent;
exports.parseAlignItems = parseAlignItems;
exports.parseAlignSelf = parseAlignSelf;
exports.parseAngle = parseAngle;
exports.parseAspectRatio = parseAspectRatio;
exports.parseBackfaceVisibility = parseBackfaceVisibility;
exports.parseBorderBlockWidth = parseBorderBlockWidth;
exports.parseBorderInlineStyle = parseBorderInlineStyle;
exports.parseBorderInlineWidth = parseBorderInlineWidth;
exports.parseBorderSideWidth = parseBorderSideWidth;
exports.parseBorderSideWidthDeclaration = parseBorderSideWidthDeclaration;
exports.parseBorderStyle = parseBorderStyle;
exports.parseBorderStyleDeclaration = parseBorderStyleDeclaration;
exports.parseBoxShadow = parseBoxShadow;
exports.parseBoxSizing = parseBoxSizing;
exports.parseCalcArguments = parseCalcArguments;
exports.parseCalcFn = parseCalcFn;
exports.parseColor = parseColor;
exports.parseColorDeclaration = parseColorDeclaration;
exports.parseColorMix = parseColorMix;
exports.parseColorOrAutoDeclaration = parseColorOrAutoDeclaration;
exports.parseCustomDeclaration = parseCustomDeclaration;
exports.parseDeclaration = parseDeclaration;
exports.parseDimension = parseDimension;
exports.parseDimensionPercentageFor_LengthValue = parseDimensionPercentageFor_LengthValue;
exports.parseDirection = parseDirection;
exports.parseDisplay = parseDisplay;
exports.parseEnv = parseEnv;
exports.parseFontColorDeclaration = parseFontColorDeclaration;
exports.parseFontSize = parseFontSize;
exports.parseFontSizeDeclaration = parseFontSizeDeclaration;
exports.parseFontStyle = parseFontStyle;
exports.parseFontStyleDeclaration = parseFontStyleDeclaration;
exports.parseFontVariantCaps = parseFontVariantCaps;
exports.parseFontVariantCapsDeclaration = parseFontVariantCapsDeclaration;
exports.parseFontWeight = parseFontWeight;
exports.parseFontWeightDeclaration = parseFontWeightDeclaration;
exports.parseGap = parseGap;
exports.parseJustifyContent = parseJustifyContent;
exports.parseLength = parseLength;
exports.parseLengthDeclaration = parseLengthDeclaration;
exports.parseLengthOrCoercePercentageToRuntime = parseLengthOrCoercePercentageToRuntime;
exports.parseLengthPercentageDeclaration = parseLengthPercentageDeclaration;
exports.parseLengthPercentageOrAuto = parseLengthPercentageOrAuto;
exports.parseLengthPercentageOrAutoDeclaration = parseLengthPercentageOrAutoDeclaration;
exports.parseLineHeight = parseLineHeight;
exports.parseLineHeightDeclaration = parseLineHeightDeclaration;
exports.parseOverflow = parseOverflow;
exports.parsePointerEvents = parsePointerEvents;
exports.parsePosition = parsePosition;
exports.parseSVGPaint = parseSVGPaint;
exports.parseScaleValue = parseScaleValue;
exports.parseSize = parseSize;
exports.parseSize2DDimensionPercentage = parseSize2DDimensionPercentage;
exports.parseSize2DDimensionPercentageDeclaration = parseSize2DDimensionPercentageDeclaration;
exports.parseSizeDeclaration = parseSizeDeclaration;
exports.parseSizeWithAutoDeclaration = parseSizeWithAutoDeclaration;
exports.parseTextAlign = parseTextAlign;
exports.parseTextDecorationLine = parseTextDecorationLine;
exports.parseTextDecorationLineDeclaration = parseTextDecorationLineDeclaration;
exports.parseTextDecorationStyle = parseTextDecorationStyle;
exports.parseTextShadow = parseTextShadow;
exports.parseTime = parseTime;
exports.parseTranslateProp = parseTranslateProp;
exports.parseUnparsed = parseUnparsed;
exports.parseUnparsedDeclaration = parseUnparsedDeclaration;
exports.parseUnresolvedColor = parseUnresolvedColor;
exports.parseUserSelect = parseUserSelect;
exports.parseVerticalAlign = parseVerticalAlign;
exports.reduceParseUnparsed = reduceParseUnparsed;
exports.round = round;
exports.unparsedFunction = unparsedFunction;
...
const unsupportedLogicalStyles = new Set(["border-inline-style", "border-inline-start-style", "border-inline-end-style", "border-block-style", "border-block-start-style", "border-block-end-style"]);
const unparsedRuntimeParsing = new Set(["animation", "animation-name", "border", "border-block-width", "border-inline-width", "box-shadow", "filter", "line-height", "rotate", "scale", "text-shadow", "transform", "translate"]);
const parsers = {
...
function parseDeclaration(declaration, builder) {
...
function parseInsetInline({
  ...
  builder.addShorthand("inset-inline", {
    "inset-inline-start": parseLengthPercentageOrAuto(value.inlineStart, builder),
...
function parseBorderBlock({
  ...
  dropUnsupportedInlineStyle(parseBorderStyle(value.style, builder), builder, "border-block-style");
}
function parseBorderBlockStart({
  ...
  dropUnsupportedInlineStyle(parseBorderStyle(value.style, builder), builder, "border-block-start-style");
}
function parseBorderBlockEnd({
  ...
  dropUnsupportedInlineStyle(parseBorderStyle(value.style, builder), builder, "border-block-end-style");
}
function parseBorderInline({
  ...
  dropUnsupportedInlineStyle(parseBorderStyle(value.style, builder), builder, "border-inline-style");
}
function parseBorderInlineStart({
  value
}, builder) {
  builder.addDescriptor("border-start-color", parseColor(value.color, builder));
  builder.addDescriptor("border-start-width", parseBorderSideWidth(value.width, builder));
  dropUnsupportedInlineStyle(parseBorderStyle(value.style, builder), builder, "border-inline-start-style");
}
function parseBorderInlineEnd({
  value
}, builder) {
  builder.addDescriptor("border-end-color", parseColor(value.color, builder));
  builder.addDescriptor("border-end-width", parseBorderSideWidth(value.width, builder));
  dropUnsupportedInlineStyle(parseBorderStyle(value.style, builder), builder, "border-inline-end-style");
}
function parseBorderInlineWidth(declaration, builder) {
  builder.addDescriptor("border-start-width", parseBorderSideWidth(declaration.value.start, builder));
  builder.addDescriptor("border-end-width", parseBorderSideWidth(declaration.value.end, builder));
}
function parseBorderInlineStyle(declaration, builder) {
  if (typeof declaration.value === "string") {
    dropUnsupportedInlineStyle(parseBorderStyle(declaration.value, builder), builder, declaration.property);
  } else {
    dropUnsupportedInlineStyle(parseBorderStyle(declaration.value.start, builder), builder, "border-inline-start-style");
    dropUnsupportedInlineStyle(parseBorderStyle(declaration.value.end, builder), builder, "border-inline-end-style");
  }
}
function dropUnsupportedInlineStyle(style, builder, property) {
...
function parseScaleValue(translate, prop, builder) {
  if (translate === "none") {
    return 1;
  }
...
function parseUnparsedDeclaration(declaration, builder) {
  ...
  if (unparsedRuntimeParsing.has(property)) {
    ...
    if (property === "animation") {
      ...
      builder.addDescriptor(property, [{}, (0, _selectors.toRNProperty)(property), args, 1]);
    }
  } else {
    ...
    if (property === "color") {
      if (!(0, _index.isStyleFunction)(value) || value[1] !== "var" || value[2] !== "-css-color") {
        builder.addDescriptor("--__rn-css-color", value);
      }
    }
  }
}
function parseCustomDeclaration(declaration, builder) {
  const property = declaration.value.name;
  if ((0, _atRules.isMappingProperty)(property)) {
    ...
    const parsedFontVariant = parseFontVariantCaps(parseUnparsed(declaration.value.value, builder, property), builder);
...
function reduceParseUnparsed(tokenOrValues, builder, property, allowAuto) {
...
function unparsedFunction(token, builder, property, allowAuto) {
  return [{}, (0, _selectors.toRNProperty)(token.value.name), reduceParseUnparsed(token.value.arguments, builder, property, allowAuto)];
}
 ...
 */
function parseUnparsed(tokenOrValue, builder, property, allowAuto = allowAutoProperties.has(property)) {
  ...
  if (Array.isArray(tokenOrValue)) {
    ...
    if (Array.isArray(args) && args.length === 1) {
      return args[0];
    } else if ((property === "filter" || property === "transform") && (0, _index.isStyleFunction)(args)) {
      return [args];
    } else {
      return args;
    }
...
function parseLengthDeclaration(declaration, builder) {
  return parseLength(declaration.value, builder);
}
function parseLength(length, builder) {
  const {
    inlineRem = 14
  } = builder.getOptions();
...
function parseAngle(angle, builder) {
...
function parseSizeDeclaration(declaration, builder) {
  return parseSize(declaration.value, builder);
}
function parseSizeWithAutoDeclaration(declaration, builder) {
  return parseSize(declaration.value, builder, {
    allowAuto: true
  });
}
function parsePointerEvents({
  value
}, builder) {
  switch (value) {
    case "none":
...
function parseSize(size, builder, options, {
  allowAuto = false
} = {}) {
...
function parseColorOrAutoDeclaration({
  value
}, builder) {
  if (value.type === "auto") {
...
function parseFontColorDeclaration(declaration, builder) {
...
function parseColorDeclaration(declaration, builder) {
  builder.addDescriptor(propertyRename[declaration.property] ?? declaration.property, parseColor(declaration.value, builder));
}
...
function parseColor(cssColor, builder) {
...
function parseLengthPercentageDeclaration(value, builder) {
  return parseLengthPercentageOrAuto(value.value, builder);
}
function parseLengthPercentageOrAutoDeclaration(value, builder) {
  return parseLengthPercentageOrAuto(value.value, builder, {
    allowAuto: true
  });
}
function parseLengthPercentageOrAuto(lengthPercentageOrAuto, builder, {
  allowAuto = false
} = {}) {
...
function parseJustifyContent(declaration, builder) {
...
function parseAlignContent(declaration, builder) {
...
function parseAlignItems(alignItems, builder) {
...
function parseAlignSelf(alignSelf, builder) {
  const allowed = new Set(["auto", "flex-start", "flex-end", "center", "stretch", "baseline"]);
  let value;
...
function parseFontWeightDeclaration(declaration, builder) {
  return parseFontWeight(declaration.value, builder);
}
function parseFontWeight(fontWeight, builder) {
...
function parseTextShadow(declaration, builder) {
...
function parseTextDecorationStyle(declaration, builder) {
...
function parseTextDecorationLineDeclaration(declaration, builder) {
  return parseTextDecorationLine(declaration.value, builder);
}
function parseTextDecorationLine(value, builder) {
...
function parseBorderStyleDeclaration(declaration, builder) {
  return parseBorderStyle(declaration.value, builder);
}
function parseBorderStyle(value, builder) {
...
function parseBorderBlockWidth(declaration, builder) {
...
function parseBorderSideWidthDeclaration(declaration, builder) {
  builder.addDescriptor(propertyRename[declaration.property] ?? declaration.property, parseBorderSideWidth(declaration.value, builder));
}
function parseBorderSideWidth(value, builder) {
...
function parseLineHeightDeclaration(declaration, builder) {
  builder.addDescriptor("line-height", parseLineHeight(declaration.value, builder));
}
function parseLineHeight(value, builder) {
  switch (value.type) {
    case "normal":
      return undefined;
    case "number":
...
function parseFontSizeDeclaration(declaration, builder) {
...
function parseFontSize(value, builder) {
  switch (value.type) {
    case "length":
      return parseLength(value.value, builder);
    case "absolute":
...
function parseFontStyleDeclaration(declaration, builder) {
  return parseFontStyle(declaration.value, builder);
}
function parseFontStyle(value, builder) {
  switch (value.type) {
    case "normal":
    case "italic":
      return value.type;
...
function parseFontVariantCapsDeclaration(declaration, builder) {
  return parseFontVariantCaps(declaration.value, builder);
}
function parseFontVariantCaps(value, builder) {
...
function parseLengthOrCoercePercentageToRuntime(value, builder) {
  return parseLength(value, builder);
}
function parseGap(declaration, builder) {
...
function parseBoxSizing(declaration, builder) {
...
function parseDirection(declaration, builder) {
...
function parseBackfaceVisibility({
  value
}, builder) {
...
function parseDimensionPercentageFor_LengthValue(value, builder) {
  if (value.type === "calc") {
    return undefined;
...
function parseEnv(value, builder) {
...
function parseCalcFn(name, tokens, builder, property) {
...
function parseColorMix(tokens, builder, property) {
  const [inToken, whitespace, colorSpace, comma, ...remaining] = tokens;
  const rest = remaining.filter(token => token.type !== "token" || !["white-space", "comment"].includes(token.value.type));
...
function parseCalcArguments([...args], builder, property) {
  const parsed = [];
...
function parseTranslateProp(value, prop, builder) {
  if (value === "none") {
    return 0;
  }
  return parseLength(value[prop], builder);
}
function parseUnresolvedColor(color, builder, property, allowAuto) {
  switch (color.type) {
    case "rgb":
...
function parseSize2DDimensionPercentageDeclaration(declaration, builder) {
  return parseSize2DDimensionPercentage(declaration.value, builder);
}
function parseSize2DDimensionPercentage(value, builder) {
  return parseLength(value[0], builder);
}
function addTransitionValue(declaration, builder) {
  switch (declaration.property) {
    ...
    case "transition-property":
      {
        builder.addDescriptor(declaration.property, declaration.value.map(v => v.property).filter(v => v in parsers && !["visibility"].includes(v) || v === "all" || v === "none").map(v => (0, _selectors.toRNProperty)(v)));
        return;
      }
    ...
    case "transition-timing-function":
      builder.addDescriptor(declaration.property, (0, _keyframes.parseEasingFunction)(declaration.value));
      return;
  }
}
function addAnimationValue(declaration, builder) {
  switch (declaration.property) {
    case "animation":
      {
        const grouped = {};
    ...
    case "animation-iteration-count":
      {
        builder.addDescriptor(declaration.property, (0, _keyframes.parseIterationCount)(declaration.value));
        break;
      }
    case "animation-name":
      {
...
function parseBackgroundImage(declaration, builder) {
  builder.addDescriptor("experimental_backgroundImage", [{}, "join", [declaration.value.flatMap(image => {
    switch (image.type) {
      case "gradient":
        {
...
function parseFilter(declaration, builder) {
  ...
  return declaration.value.value.map(value => {
    switch (value.type) {
      ...
      case "hue-rotate":
        return {
          [(0, _selectors.toRNProperty)(value.type)]: parseAngle(value.value, builder)
        };
      case "drop-shadow":
        return [{}, (0, _selectors.toRNProperty)(value.type), [parseLength(value.value.xOffset, builder), parseLength(value.value.yOffset, builder), parseLength(value.value.blur, builder), parseColor(value.value.color, builder)]];
      case "url":
        return;
    }
