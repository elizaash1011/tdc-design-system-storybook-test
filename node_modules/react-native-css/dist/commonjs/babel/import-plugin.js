...
function _default({
  ...
  const packageRoot = (0, _path.resolve)(__dirname, (0, _path.basename)((0, _path.dirname)(__dirname)) === "src" ? "../.." : "../../..");
  const thisModuleDist = (0, _path.resolve)(packageRoot, "dist") + _path.sep;
  const thisModuleSrc = (0, _path.resolve)(packageRoot, "src") + _path.sep;
    ...
    visitor: {
      ...
      VariableDeclaration(path, state) {
        ...
        if (t.isIdentifier(id) && t.isIdentifier(init.callee, {
          ...
          statements = (0, _reactNativeWeb.handleReactNativeWebInteropRequireDefault)(path, t, id.name, init, source, state.filename);
        }
        if (!statements) {
          return;
        }
