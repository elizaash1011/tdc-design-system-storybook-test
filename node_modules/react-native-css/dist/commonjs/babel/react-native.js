...
exports.handleReactNativeIdentifierRequire = handleReactNativeIdentifierRequire;
exports.handleReactNativeImport = handleReactNativeImport;
exports.handleReactNativeObjectPatternRequire = handleReactNativeObjectPatternRequire;
var _path = require("path");
var _allowedModules = require("./allowedModules.js");
function parseReactNativeSource(source, filename) {
  if (source.startsWith(".")) {
    source = (0, _path.resolve)((0, _path.dirname)(filename), source);
...
function handleReactNativeImport(declaration, t, filename) {
  const {
    specifiers,
    source
  } = declaration;
...
function handleReactNativeIdentifierRequire(path, t, id, source, filename) {
...
function handleReactNativeObjectPatternRequire(path, t, id, source, filename) {
  const parsedSource = parseReactNativeSource(source, filename);
