...
import { activeFamily, cleanupEffect, containerLayoutFamily, focusFamily, hoverFamily, VAR_SYMBOL, weakFamily } from "../reactivity.js";
...
currentProps = state.currentProps, inheritedVariables = state.inheritedVariables, inheritedContainers = state.inheritedContainers, forceUpdate = false, isRerender = true) {
  ...
  if (usesVariables || variables || inlineVariables.size) {
    ...
    if (inlineVariables.size) {
      variables = Object.assign({}, inheritedVariables, variables, ...Array.from(inlineVariables), {
        [VAR_SYMBOL]: true
      });
    }
