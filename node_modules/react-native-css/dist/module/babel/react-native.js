...
export function handleReactNativeImport(declaration, t, filename) {
  const {
    specifiers,
    source
  } = declaration;
...
export function handleReactNativeIdentifierRequire(path, t, id, source, filename) {
...
export function handleReactNativeObjectPatternRequire(path, t, id, source, filename) {
  const parsedSource = parseReactNativeSource(source, filename);
