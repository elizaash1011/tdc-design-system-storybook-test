...
import { Specificity } from "../utilities/index.js";
...
export function getClassNameSelectors(selectors, options = {}) {
  if (!selectors.length) {
    return [];
  }
    ...
    case "pseudo-element":
      {
        switch (component.kind) {
          ...
          case "placeholder":
            {
              specificity[Specificity.PseudoElements] = (specificity[Specificity.PseudoElements] ?? 0) + 1;
          ...
          case "hover":
            {
              ...
              specificity[Specificity.PseudoClass] = (specificity[Specificity.PseudoClass] ?? 0) + 1;
              return parseComponents(rest, options, root, ref, specificity);
            }
          case "active":
            {
    ...
    case "attribute":
      {
        ...
        for (const query of queries) {
          if (type === "is") {
            query.specificity[Specificity.ClassName] = (query.specificity[Specificity.ClassName] ?? 0) + 1;
          }
...
export function toRNProperty(str) {
